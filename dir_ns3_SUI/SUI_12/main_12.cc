...
//-----------------------------------------------------OpenFLow
	...
	//AUTOCODE ANIMATION INICIO
	  AnimationInterface anim ("scratch/animations/animation_SUI_12.xml");
...
//-----------------------------------------------------Schedule/Callbacks
	 ...
	 */
	//INICIO FLOW MONITOR
	  flowmon->SerializeToXmlFile ("scratch/switch_SUI_flowmon/switch_SUI_12.flowmon", false, false);
	//FIM FLOW MONITOR
